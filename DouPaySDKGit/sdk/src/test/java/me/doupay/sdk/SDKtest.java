...
public class SDKtest {
    ...
    public void getCoinInfo() {
        ...
        PaymentInfo.getCoinInfo("0001", new CallBackListener<CoinCodeResponseData>() {
            @Override
            public void onFinish(CoinCodeResponseData data) {
    ...
    public void getPay() {
        ...
        Constants.getInstance().init(secret, privateKey, appId, "3600000");
                ...
                PaymentInfo.pay("10000", CoinCodeEnum.BTC, CurrencyCodeEnum.CNY, "17701278922", "202105201234",
